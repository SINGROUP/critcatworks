...
critcatworks is a workflow manager based on fireworks
...
Contribute by raising an issue on github if you encounter a problem, or become develop your own
nanocluster workflow. Follow the guidelines in the developer tutorial
