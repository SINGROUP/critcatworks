...
if __name__ == "__main__":
    ...
    launchpad = mylaunchpad.create_launchpad(USERNAME, PASSWORD, server = "serenity", lpadname = "mjfireworksvilje")
    ...
    if IS_QUEUE:
        ...
        for i in range(0, 200000):
            for category, adapter in zip(['dft', 'large', 'medium', 'lightweight'], [dft, large, medium, lightweight]):
